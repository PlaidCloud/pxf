...
from qautils.gppylib.gplog import *          # Greenplum logging facility
from qautils.gppylib.commands import base    # Greenplum layer for worker pools
from qautils.gppylib.commands import unix    # Greenplum layer for unix interaction
from qautils.gppylib.commands.gp import GpCreateDBIdFile
from qautils.gppylib.db import dbconn
from qautils.gppylib.gpversion import GpVersion
from qautils.gppylib.gparray import GpArray, GpDB
from qautils.gppylib.gphostcache import GpHostCache
from qautils.gppylib.gpcoverage import GpCoverage
from qautils.gppylib.operations.gpMigratorUtil import *
...
class GPUpgradeBase(object):
    ...
    #------------------------------------------------------------
    def RunCmd(self, cmd, env=None, utility=False, supressDebug=False):
        '''
